				...
				<ul class="accordion-group" id="accordion">
					<li style="background-image: url('img/1.jpg');" onclick="sell()">
						...
						<section class="hidden-xs">
							<article>
								<p>IMPORTANT: We are currently only buying Champion Crate #1s due to a large stock of #2s. If you would like to sell #2s, please come back later as your sell order will be denied for #2s.</p>
